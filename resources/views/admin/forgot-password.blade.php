                ...
                <div class="login-body container">
                    <div class="loginbox">
                        <div class="login-right-wrap">
                            ...
                            <form action="{{ route('admin.forgot-password-email') }}" method="post" id="adminResetPasswordForm">
                            	@csrf                                
                                ...
                                <div class="text-center">
                                    <button class="btn btn-primary btn-block account-btn" type="submit">Send Email</button>
                                </div>
